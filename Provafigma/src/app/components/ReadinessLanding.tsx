...
const steps: Step[] = [
  ...
  },
  {
    ...
    body: "Non «hai completato tutto il piano». «Ci siamo: il punto critico è l'apertura conversazionale, non il contenuto.» Un punto di chiusura definito.",
  },
  {
    n: "05",
    ...
    <div style={{ padding: "120px 48px 96px", borderBottom: `0.5px solid ${BORDER}`, fontFamily: FONT }}>
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        ...
        <div style={{ fontSize: 64, fontWeight: 500, color: BLACK, lineHeight: 1.05, letterSpacing: "-0.02em", marginBottom: 32, maxWidth: 1100 }}>
          ...
          <span style={{ color: GRAY }}> Non «hai completato tutto il piano». «Ci siamo, il punto critico è l'apertura.»</span>
        </div>
